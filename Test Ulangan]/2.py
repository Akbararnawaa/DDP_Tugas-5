...
pesan_menu = input("Pesan Menu Apa? (makanan atau minuman): ").lower()
if pesan_menu == "makanan":
    print("Menu Makanan:")
    print("1. Nasi Goreng - Rp. 15.000")
    print("2. Mie Goreng - Rp. 12.000")
    print("3. Ayam Geprek - Rp. 18.000")
    menu_pilihan = input("Masukkan pesanan (Nasi Goreng/Mie Goreng/Ayam Geprek): ").lower()
    ...
    menu_pilihan = input("Masukkan pesanan (Aneka Jus/Soft Drink/Sweet Ice Tea): ").lower()
    jumlah_pesanan = int(input("Masukkan Jumlah Pesanan: "))
